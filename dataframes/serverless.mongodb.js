...
use(database);
// db.createCollection(stock_collection);
// db.createCollection(cat_collection)
// db.stock.createIndex({ "category": 1 })

// db.stock.find({ "category": "ETF" }).explain("executionStats")
// db.stock.find({ "category": "RETAIL" }).explain("executionStats")
db.getCollection(cat_collection).insertMany([
